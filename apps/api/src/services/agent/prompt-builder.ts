...
const PLATFORM_RULES: Record<Platform, string> = {
  ...
  telegram:
    "Conversational, community-first. Markdown formatting supported. No character limit. Can include links naturally.",
  facebook:
    "Emotional engagement focus. 80 characters ideal for organic reach but up to 400 acceptable. 1–3 hashtags. Use storytelling.",
  tiktok:
    'Hook in first 3 words — this is the caption shown before "more". Trend-aware. 3–5 hashtags. Be energetic and direct.',
};
